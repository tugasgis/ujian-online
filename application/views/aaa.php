...
<nav class="navbar navbar-findcond navbar-fixed-top">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand">At-Tashdiq Indonesia</a>
    </div>
...
if ($sess_level == "guru") {
  $menu = array(
	...
	echo "<script>alert('Selamat anda telah terdaftar, silahkan anda tranfer ke Rek:');</script>";
  $menu = array(
            array("icon"=>"dashboard", "url"=>"", "text"=>"Dashboard"),
            array("icon"=>"file", "url"=>"ikuti_ujian", "text"=>"Ujian"),
			array("icon"=>"file", "url"=>"konfrimasi", "text"=>"Konfrimasi"),
          )
		  ;
  ...
  $menu = array(
            ...
            array("icon"=>"list-alt", "url"=>"m_guru", "text"=>"Data Ustadz"),
...
<div class="col-md-12" style="border-top: solid 4px #ddd; text-align: center; padding-top: 10px; margin-top: 50px; margin-bottom: 20px">
  &copy; 2017 <a href="<?php echo base_url(); ?>adm">At-Tashdiq Indonesia</a>. 
</div>
